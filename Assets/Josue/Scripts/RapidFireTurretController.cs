...
public class RapidFireTurretController : MonoBehaviour
{
    ...
    [SerializeField] private float cooldownBetweenBursts = 1.2f;
    ...
    private void FireSingleShot()
    {
        ...
        {
            Debug.LogError("RapidFireTurret projectilePrefab has no Projectile component!");
        }
    }
